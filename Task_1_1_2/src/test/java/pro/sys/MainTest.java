...
class MainTest {
    ...
    void testInteractive() {
        ...
        String expectedString = """
            ...
            [Закрыто, семерка треф] => (min 7)
            Ваши карты:
            [десятка треф, четверка треф] => (14)
            Ещё? (y/N)
            Ваши карты:
            [десятка треф, четверка треф, двойка треф] => (16)
            Ещё? (y/N)
            Дилер открывает карты:
            [десятка треф, семерка треф] => (17)
            ...
            Раунд 4
            Карты дилера:
            [десятка треф, семерка треф] => (min 17)
            Ваши карты:
